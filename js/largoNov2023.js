...
let textoEscLargoActual = "Valores Noviembre 2023"; // CAMBIAR FECHA Cuando Se Actualiza
let textoEscLargoPasada = "Valores Octubre 2023"; // CAMBIAR FECHA Cuando Se Actualiza
let textoEscLargoSel = textoEscLargoActual;

// lista de valores Noviembre 2023
...
let listaValoresLargoPasada = [
  // lista de valores Octubre 2023
  0, 179830, 135585, 100236, 168564, 123839, 179830, 135585, 135585, 100236,
  179830, 123839, 200354, 176807, 160849, 135585, 106046, 135585, 123839,
  100236, 100236, 106046, 135585, 123839, 112037, 100236, 100236, 200354,
  170997, 135585, 123839, 170997, 123839, 100236, 123839, 100236, 123839,
  135585, 117910, 100236, 170997, 135585, 170997, 135585, 135585, 200354,
  137466, 100236, 48095,
];
let listaRolesLargo = [
  //lista de roles 2023
